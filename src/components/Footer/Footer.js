...
const Footer = () => {
    return (
        <>
            ...
            <footer
                className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-blue-400 dark:text-white">
                ...
                <div className="w-full bg-black/5 p-4 text-center">
                    © 2024 Copyright:
                    <a href="https://tw-elements.com/">Sanjay Singh Rajawat</a>
                </div>
            </footer>
        </>
    )
